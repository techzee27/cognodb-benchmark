...
| :--- | :--- |
| **1-Hop Traversal Latency** | ![1-Hop Traversal](docs/charts/traversal_1hop.png) |
| **2-Hop Traversal Latency** | ![2-Hop Traversal](docs/charts/traversal_2hop.png) |
| **3-Hop Traversal Latency** | ![3-Hop Traversal](docs/charts/traversal_3hop.png) |
| **Point Lookup Latency** | ![Point Lookup](docs/charts/point_lookup.png) |
| **Filtered Lookup Latency** | ![Filtered Lookup](docs/charts/filtered_lookup.png) |
| **Aggregation Count Latency** | ![Aggregation Count](docs/charts/aggregation_count.png) |
